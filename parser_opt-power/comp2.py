...
def main():
    ...
    old = path_f+''.join([file for file in os.listdir(path_f) if 'second' in file and 'csv' in file])
    new = path_f+''.join([file for file in os.listdir(path_f) if 'first' in file and 'csv' in file])
